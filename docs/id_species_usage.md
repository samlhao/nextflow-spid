# nextflow-spid: ID Species Documentation
...
This will launch the pipeline with the `docker` configuration profile. See [here](#-profile) for more information about profiles.
